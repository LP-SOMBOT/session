            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'SOMBOT-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://whatsapp.com) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [Malvin King GitHub Repo](https://github.com/LP-SOMBOT/SOMBOT)  

🚀 _Thanks for choosing SOMBOT-MD — Let the automation begin!_ ✨`;
